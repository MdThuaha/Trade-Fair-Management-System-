...
namespace TFMS.API.Migrations
{
    ...
    [Migration("20240521035022_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TFMS.Lib.Models.Booking", b =>
                {
                    ...
                    b.Property<int>("NumberOfPavilion")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TFMS.Lib.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("TFMS.Lib.Models.Pavilion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PavilionName = "Conrner Pavilion",
                            PavilionNumber = "P-101",
                            Rent = 6000m,
                            Size = "10X12",
                            SqFoot = 120.0
                        },
                        new
                        {
                            ...
                            PavilionName = "Box Pavilion",
                            PavilionNumber = "P-201",
                            Rent = 6000m,
                            Size = "10X10",
                            SqFoot = 100.0
                        },
            ...
            modelBuilder.Entity("TFMS.Lib.Models.PavilionCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            PavilionCategoryId = 4,
                            CategoryName = "B-41",
                            Description = " Middle North Side Pavilion",
                            FarePerSquareFeet = 60m,
                            PavilionType = 2
                        },
                        new
                        {
                            PavilionCategoryId = 5,
                            CategoryName = "B-43",
                            Description = "Middle South Side Pavilion",
                            FarePerSquareFeet = 60m,
                            PavilionType = 2
                        });
                });
            ...
            modelBuilder.Entity("TFMS.Lib.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("TFMS.Lib.Models.Product", b =>
                {
                    b.HasOne("TFMS.Lib.Models.Category", "Category")
                        .WithMany("Products")
